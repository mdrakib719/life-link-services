...
import { Book, Home as HomeIcon, Utensils, ShoppingBag, Users, Calendar, Star, MessageSquare } from "lucide-react";
    ...
    <div>
        ...
        <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 lg:pr-12 mb-10 lg:mb-0">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
              Student Life, <span className="text-life-blue-500">Simplified</span>
            </h1>
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
              LifeLink connects students with essential services - from finding the perfect flat to 
              ordering meals and accessing local shops, all in one place.
            </p>
          ...
          <div className="lg:w-1/2 animate-fade-in">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 transform rotate-2 relative">
              ...
              <img 
                src="https://images.unsplash.com/photo-1523050854058-8df90110c9f1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxfDB8MXxhbGx8fHx8fHx8fHwxNjIwOTEyMDEx&ixlib=rb-1.2.1&q=80&w=1080" 
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Everything you need for comfortable student life, all in one platform
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Card className="card-hover">
            <CardContent className="p-6">
              ...
              <Link to="/services/flats" className="mt-4 text-life-blue-500 hover:underline inline-block">
                Browse Flats →
              </Link>
            </CardContent>
          </Card>
          ...
          <Card className="card-hover">
            <CardContent className="p-6">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Customizable meal plans with healthy, delicious options delivered to you.
              </p>
              <Link to="/services/meals" className="mt-4 text-life-blue-500 hover:underline inline-block">
                View Meal Plans →
              </Link>
            </CardContent>
          </Card>
          ...
          <Card className="card-hover">
            <CardContent className="p-6">
              ...
              <Link to="/services/shops" className="mt-4 text-life-blue-500 hover:underline inline-block">
                Explore Shops →
              </Link>
            </CardContent>
          </Card>
      ...
      <section className="bg-gray-50 dark:bg-gray-800 py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Why Choose LifeLink</h2>
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              We're building a community-focused platform that makes student life easier
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600 dark:text-gray-300">Built by students, for students - with your needs in mind.</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-sm">
              ...
              <h3 className="font-semibold text-xl mb-2">Convenient Scheduling</h3>
              <p className="text-gray-600 dark:text-gray-300">Easily book and manage your services on your schedule.</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600 dark:text-gray-300">All services and accommodations are vetted for quality.</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600 dark:text-gray-300">Get help whenever you need it through our support system.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="bg-life-blue-500 dark:bg-life-blue-600 rounded-xl shadow-xl overflow-hidden">
          <div className="px-6 py-12 md:p-12 text-center">
            <h2 className="text-3xl font-bold text-white mb-4">Ready to simplify your student life?</h2>
            <p className="text-blue-100 text-lg mb-8 max-w-2xl mx-auto">
              Join thousands of students who are already enjoying the benefits of LifeLink Services.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link to="/services">
                <Button variant="outline" className="text-white border-white hover:bg-life-blue-600 btn-hover">
                  Explore Services
                </Button>
              </Link>
            </div>
